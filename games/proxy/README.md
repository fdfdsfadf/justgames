Based on the ultraviolet system Interstellar is the proxy being developed by the macbooksuck development team. If you have been given early access perms continue to the link [Link Tex2](https://macbooksuper) bear in mind that you must have the username and password to access it. 
...
# How can I get to use the proxy
...
# IT IS ON [Link Text](https:macbooksuper.xyz)

Preview image (it doesn't work if you click on it I swear I see so many braindeads clicking on it thinking that it will somehow work when it clearly says to go to the website)
![Interstellar preview :eyes: ](https://raw.githubusercontent.com/fdfdsfadf/Cat-nitro-with-chat-room/refs/heads/website/games/proxy/Interstellar.jpg)
