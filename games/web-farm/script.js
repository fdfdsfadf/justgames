        ...
        let CROP_DATA = {
            'wheat': { name: 'Wheat', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/wheat.png" alt="Wheat" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 5, sellPrice: 12, growTime: 10000, weightRange: [0.9, 1.1] },
            'carrot': { name: 'Carrot', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/carrot.png" alt="Carrot" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 14, sellPrice: 32, growTime: 20000, weightRange: [0.85, 1.15] },
            'lettuce': { name: 'Lettuce', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/lettuce.png" alt="Lettuce" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 18, sellPrice: 42, growTime: 24000, weightRange: [0.8, 1.2] },
            'potato': { name: 'Potato', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/potato.png" alt="Potato" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 24, sellPrice: 55, growTime: 28000, weightRange: [0.9, 1.1] },
            'corn': { name: 'Corn', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/corn.png" alt="Corn" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 32, sellPrice: 72, growTime: 35000, weightRange: [0.9, 1.1] },
            'strawberry': { name: 'Strawberry', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/strawberry.png" alt="Strawberry" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 42, sellPrice: 92, growTime: 30000, weightRange: [0.95, 1.05] },
            'kiwi': { name: 'Kiwi', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/kiwi.png" alt="Kiwi" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 55, sellPrice: 120, growTime: 32000, weightRange: [0.9, 1.1] },
            'mango': { name: 'Mango', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/mango.png" alt="Mango" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 70, sellPrice: 155, growTime: 38000, weightRange: [0.85, 1.3] },
            'mushroom': { name: 'Mushroom', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/mushroom.png" alt="Mushroom" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 90, sellPrice: 195, growTime: 45000, weightRange: [0.7, 1.3] },
            'cherry': { name: 'Cherry', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/cherry.png" alt="Cherry" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 110, sellPrice: 240, growTime: 55000, weightRange: [0.95, 1.05] },
            'peach': { name: 'Peach', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/peach.png" alt="Peach" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 135, sellPrice: 290, growTime: 31000, weightRange: [0.9, 1.1] },
            'grapes': { name: 'Grapes', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/grapes.png" alt="Grapes" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 130, sellPrice: 280, growTime: 60000, weightRange: [0.9, 1.1] },
            'tomato': { name: 'Tomato', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/tomato.png" alt="Tomato" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 165, sellPrice: 350, growTime: 70000, weightRange: [0.85, 1.15] },
            'broccoli': { name: 'Broccoli', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/broccoli.png" alt="Broccoli" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 140, sellPrice: 290, growTime: 80000, weightRange: [0.8, 1.3] },
            'tree': { name: 'Tree', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/tree.png" alt="Tree" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 180, sellPrice: null, growTime: 120000, yields: ['apple', 'banana', 'orange'] },
            'eggplant': { name: 'Eggplant', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/eggplant.png" alt="Eggplant" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 200, sellPrice: 420, growTime: 90000, weightRange: [0.85, 1.3] },
            'avocado': { name: 'Avocado', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/avocado.png" alt="Avocado" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 220, sellPrice: 460, growTime: 85000, weightRange: [0.9, 1.15] },
            'watermelon': { name: 'Watermelon', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/watermelon.png" alt="Watermelon" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 280, sellPrice: 580, growTime: 100000, weightRange: [0.7, 1.3] },
            'lemon': { name: 'Lemon', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/lemon.png" alt="Lemon" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 400, sellPrice: 830, growTime: 75000, weightRange: [0.9, 1.1] },
            'pear': { name: 'Pear', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/pear.png" alt="Pear" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 600, sellPrice: 1250, growTime: 85000, weightRange: [0.85, 1.15] },
            'cactus': { name: 'Cactus', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/cactus.png" alt="Cactus" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 1200, sellPrice: 2500, growTime: 90000, weightRange: [0.8, 1.3] },
            'chilli': { name: 'Chilli', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/chilli.png" alt="Chilli" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 2500, sellPrice: 5200, growTime: 110000, weightRange: [0.8, 1.25] },
            'palm_tree': { name: 'Palm Tree', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/palm_tree.png" alt="Palm Tree" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 1800, sellPrice: null, growTime: 140000, yields: ['coconut'] },
            'melon': { name: 'Melon', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/melon.png" alt="Melon" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 12000, sellPrice: 25000, growTime: 150000, weightRange: [0.85, 1.15], rarity: 'ultra_rare', stockChance: 0.20 },
            'cherry_blossom': { name: 'Cherry Blossom', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/cherry_blossom.png" alt="Cherry Blossom" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 35000, sellPrice: 72000, growTime: 180000, weightRange: [0.85, 1.15], rarity: 'ultra_rare', stockChance: 0.10 },
            'dango': { name: 'Dango', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/dango.png" alt="Dango" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 80000, sellPrice: 165000, growTime: 200000, weightRange: [0.9, 1.1], rarity: 'ultra_rare', stockChance: 0.08 },
            'taco': { name: 'Taco', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/taco.png" alt="Taco" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: null, sellPrice: 1500000, growTime: 240000, weightRange: [0.9, 1.1], rarity: 'ultra_rare', stockChance: 1.0, isEvent: true, eventWeather: 'raining_tacos' },
            'bell_pepper': { name: 'Bell Pepper', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/bell_pepper.png" alt="Bell Pepper" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 2000000, sellPrice: 3000000, growTime: 600000, weightRange: [0.95, 1.05], rarity: 'ultra_rare', stockChance: 0.05 },
            'dragonfruit': { name: 'Dragonfruit', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/dragonfruit.png" alt="Dragonfruit" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 1000000, sellPrice: 1200000, growTime: 400000, weightRange: [0.95, 1.07], rarity: 'ultra_rare', stockChance: 0.08 },
            'pomegranate': { name: 'Pomegranate', icon: '<img src="http://raw.githubusercontent.com/guahhinc/webfarm/main/pomegranate.png" alt="Pomegranate" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 5000000, sellPrice: 7500000, growTime: 450000, weightRange: [0.9, 1.1], rarity: 'ultra_rare', stockChance: 0.05 },
            'litchi': { name: 'Litchi', icon: '<img src="http://raw.githubusercontent.com/guahhinc/webfarm/main/litchi.png" alt="Litchi" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 15000000, sellPrice: 21500000, growTime: 500000, weightRange: [0.9, 1.1], rarity: 'ultra_rare', stockChance: 0.03 },
            'apple': { name: 'Apple', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/apple.png" alt="Apple" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: null, sellPrice: 135, growTime: null, weightRange: [0.9, 1.1] },
            'banana': { name: 'Banana', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/banana.png" alt="Banana" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: null, sellPrice: 220, growTime: null, weightRange: [0.85, 1.15] },
            'orange': { name: 'Orange', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/orange.png" alt="Orange" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: null, sellPrice: 175, growTime: null, weightRange: [0.9, 1.1] },
            'pineapple': { name: 'Pineapple', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/pineapple.png" alt="Pineapple" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: 20000, sellPrice: 30000, growTime: 48000, weightRange: [0.8, 1.1] },
            'coconut': { name: 'Coconut', icon: '<img src="https://raw.githubusercontent.com/guahhinc/webfarm/main/coconut.png" alt="Coconut" style="height: 1.3em; width: 1.3em; object-fit: contain; vertical-align: middle;">', seedCost: null, sellPrice: 2900, growTime: null, weightRange: [0.9, 1.3] },
        };
        ...
        let ACHIEVEMENT_DATA = {
            ...
            'harvest_pineapple': { name: "Pineapple Power", icon: "🍍", desc: "Harvest a Pineapple.", rwd: 22, type: 'stats.h', tgt: 'pineapple', thr: 1 },
            ...
            'rebirth_1': { name: "First Rebirth", icon: "🔄", desc: "Complete your first Rebirth.", rwd: 50000, type: 'state.rb', thr: 1 },
            'upgrade_growth_max': { name: "Max Velocity", icon: "🚀", desc: `Reach max growth speed (Level 7).`, rwd: 500, type: 'state.g', thr: 7 },
            'harvest_silver': { name: "Silver Lining", icon: "🥈", desc: "Harvest your first Silver crop.", rwd: 300, type: 'stats.mut', tgt: 'silver', thr: 1 },
        ...
        const WEATHER_CONFIG = {
            ...
            'raining_tacos': {
                name: 'Raining Tacos', icon: '🌮', duration_ms: [3 * 60 * 1000, 5 * 60 * 1000], effects: [
        ...
        const refreshShopStock = () => {
            ...
            shuffleArray(allGears);
            gameState.shopCurrentlyAvailableGearKeys = allGears.slice(0, 4);
        ...
        const updateUI = () => {
            ...
            const generateInventoryList = (items, type) => {
                ...
                return sorted.map(item => {
                    ...
                    if (type === 'seeds') {
                        ...
                        return `<li data-item-key="${item.key}" data-inv-type="${type}" data-tt-name="${ttName}" data-tt-detail="${ttDetail}" class="${liClass}"><span class="inv-tile-icon">${item.displayPrefix}${item.icon}</span><span class="inv-tile-name">${displayName}</span><span class="inv-tile-count">x${count}</span></li>`;
                    }
            ...
            if (gearInventoryEl) {
                ...
                if (gearEntries.length === 0) {
                    gearInventoryEl.innerHTML = '<li class="empty-grid-msg">No gears. Buy some from the gear shop!</li>';
                } else {
                    gearInventoryEl.innerHTML = gearEntries.map(k => {
                        ...
                        return `<li class="gear-inv-item ${selectedClass}" data-gear-key="${k}" onclick="selectGearToPlace('${k}')" title="${gInfo.description}"><span class="inv-tile-icon">${gInfo.icon}</span><span class="inv-tile-name">${gInfo.name}</span><span class="inv-tile-count">x${count}</span></li>`;
                    }).join('');
                }
            }
            ...
            buySeedsEl.innerHTML = plantableCropsOverall.map(k => {
                ...
                if (!isInStock) {
                    ...
                    const titleText = co === 0 ? "Get for Free" : `Buy ${purchaseQtySeeds} ${c.name} for ${totalCost.toLocaleString()}💰`;
                    const isDisabledClass = (co > 0 && gameState.money < totalCost) ? 'disabled' : '';
                    return `<li class="plant-button ${isDisabledClass}" onclick="buySeeds('${k}',${purchaseQtySeeds})" title="${titleText}"><span class="shop-tile-icon">${c.icon}</span><span class="shop-tile-name">${c.name}</span><span class="shop-tile-price">${costText}</span></li>`;
                }
            }).join('');
            ...
            if (buyGearsEl) {
                ...
                if (!gameState.shopCurrentlyAvailableGearKeys || gameState.shopCurrentlyAvailableGearKeys.length === 0) {
                    const allGears = [...allGearsKeys];
                    shuffleArray(allGears);
                    gameState.shopCurrentlyAvailableGearKeys = allGears.slice(0, 4);
                }
                buyGearsEl.innerHTML = allGearsKeys.map(k => {
                    const g = GEAR_DATA[k];
                    const isInStock = gameState.shopCurrentlyAvailableGearKeys.includes(k);
                    ...
                    if (!isInStock) {
                        ...
                        const titleText = `Buy ${g.name} for ${formatMoney(totalCost)} 💰 - ${g.description}`;
                        return `<li class="plant-button ${isDisabledClass}" onclick="buyGear('${k}', 1)" title="${titleText}"><span class="shop-tile-icon">${g.icon}</span><span class="shop-tile-name">${g.name}</span><span class="shop-tile-price">${formatMoney(totalCost)}💰</span></li>`;
                    }
                }).join('');
            }
        ...
        const createInitialGameState = (resetCrops = true) => {
            ...
            const state = {
                v: SAVE_CODE_VERSION, money: 0, plots: [], inventory: { seeds: {}, produce: {}, gears: {} }, achievements: {},
        ...
        const setupEventListeners = () => { if (saveCodeInputEl && devConsoleEl && devCommandInputEl) { saveCodeInputEl.addEventListener('input', () => { if (saveCodeInputEl.value === DEV_ACTIVATION_CODE) { isDevModeEnabled = !isDevModeEnabled; devConsoleEl.style.display = isDevModeEnabled ? 'block' : 'none'; messagesEl.style.display = isDevModeEnabled ? 'block' : 'none'; saveCodeInputEl.value = ''; if (isDevModeEnabled) setTimeout(() => devCommandInputEl.focus(), 50); } }); devCommandInputEl.addEventListener('keydown', (e) => { if (e.key === 'Enter') { e.preventDefault(); processDevCommand(); } }); } else console.error("Cannot setup dev listeners"); farmGridEl.addEventListener('mouseover', (event) => { const tP = event.target.closest('.plot'); if (tP && !tP.classList.contains('locked')) { const pId = parseInt(tP.dataset.plotId, 10); if (!isNaN(pId)) showPlotTooltip(pId, event); } else hidePlotTooltip(); }); farmGridEl.addEventListener('mouseout', (event) => { if (!farmGridEl.contains(event.relatedTarget)) hidePlotTooltip(); else { const fP = event.target.closest('.plot'); const tE = event.relatedTarget; if (fP && (!tE || !fP.contains(tE))) { const tP = tE?.closest('.plot'); if (!tP || tP.classList.contains('locked')) hidePlotTooltip(); } } }); farmGridEl.addEventListener('mousemove', movePlotTooltip); if (inventoryEl) { inventoryEl.addEventListener('contextmenu', (e) => { const li = e.target.closest('li[data-item-key]'); if (li && produceInventoryEl.contains(li)) { e.preventDefault(); } }); inventoryEl.addEventListener('click', (e) => { const li = e.target.closest('li[data-item-key]'); if (li) { const itemKey = li.dataset.itemKey; if (!itemKey) return; if (seedInventoryEl.contains(li)) { selectCropToPlant(itemKey); } else if (produceInventoryEl.contains(li)) { if (produceActionMode === 'sell') { sellProduce(itemKey, 1); } else if (produceActionMode === 'lock') { toggleLockProduce(itemKey); } } } }); } const invContainers = [seedInventoryEl, produceInventoryEl]; invContainers.forEach(container => { if (!container) return; container.addEventListener('mouseover', (e) => { const li = e.target.closest('li[data-item-key]'); if (li) showInventoryTooltip(li, e); }); container.addEventListener('mouseout', (e) => { const li = e.target.closest('li[data-item-key]'); if (li && (!e.relatedTarget || !li.contains(e.relatedTarget))) hideInventoryTooltip(); }); container.addEventListener('mousemove', moveInventoryTooltip); }); /* Additional mouseleave on each container to ensure tooltip hides */ invContainers.forEach(container => { if (!container) return; container.addEventListener('mouseleave', () => { hideInventoryTooltip(); }); }); }
